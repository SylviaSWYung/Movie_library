...
import movielibrary.core.Movie;
  ...
  public class AddMoviePageController {
     ...
     * valid, it creates a new {@link Movie} object and adds it to the library using the {@code access} object.
     * If the movie title already exists or the input is invalid, it catches the respective exceptions 
     * and displays an appropriate error alert.
     *
