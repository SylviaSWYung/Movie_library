 ...
 * The user interaction includes lending a movie with the {@code lend} button, and returning a lend movie with {@code return} button. 
...
public class MoviePageController {
    ...
    /**
     * Declare movieDeserializer variable of type {@link MovieDeserializer}, and movieSerializer variable of type {@link MovieSerializer}.
     * Declare movieManager variable of type {@link MovieManager}, and movie variable of type {@link Movie}.
     */
    ...
    /**
     * Handles the movie data {@code movieTitle}, {@code description} and {@code movieLength} from the chosen movie.
     ...
     * @param movielength A String with the length of the chosen movie
     */
    ...
    /**
     * Handles the {@code return} button, returns the movie. Finds the chosen movie and checks if it is lent.
     * If the movie is not lent, the program will give an error alert. If the movie is lent, it sets the movie as not lent (returns) and gives a confirmation alert.
     * @throws IOException Throws IOException if an I/O error occurs while accessing the file
     */
    @FXML
